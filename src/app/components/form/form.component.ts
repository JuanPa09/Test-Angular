...
export class FormComponent implements OnInit {
  ...
  departmentsRequest: string =
    'https://capaportaldatosabiertos.mingob.gob.gt/api/dataset/7f3ea5e50ea1b9ab7e988eade7b29dbc';
  concessionaire: Array<string> = [
    'Concesionario Norte',
    'Concesionario Sur',
    'Concesionario Este',
    'Concesionario Oeste',
  ...
  submitInfo() {
    ...
    let phoneL = this.dataForm.get('phone')?.value?.toString().length! != 8?true:false;
    ...
    } else if (phone === '' || phoneL ) {
      document.getElementById('phone')?.classList.add('is-invalid');
      alert('Celular debe tener 8 números')
    } else if (address === '') {
